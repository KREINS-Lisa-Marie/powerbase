<x-public.app title="{{__('general.legals')}}">
            <h2 class="public-page-title fw-700 t-a-center color-dark p-b-0">
                {{__('public/legals.legal-title')}}
            </h2>
            <p class="legal-info-date t-a-center">
                {{__('public/legals.last_updated')}} 26.07.2026
            </p>
    <section class="background-white legals-section p-t-b-60-150 p-l-r-24  ">
        <h3 class="sro" aria-level="3" role="heading">
            {{__('public/legals.legals-definition')}}
        </h3>
        <div class="max-w-web legals-text body-content m-l-r-main">
