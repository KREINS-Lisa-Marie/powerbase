<main {{--class="main-container"--}} id="content" class="admin dashboard-page">
    <x-admin.page-bar>
...
<div class="main-container">
    <section class="welcome-dashobard-section ">
        <x-admin.components.page-title>
            {{__('admin/dashboard.hello')}} Eric
        </x-admin.components.page-title>
        <ul class="dashboard-lists">
            <x-list-items>
                <a href="{{route('pages::dashboard.index', ['locale' => __('general.currentLocale')])}}" class="d-block dark-button-background color-white regular-shadow bold dashboard-btn">
            ...
            @for($i=0; $i<5; $i++)
                ...
                <tr class="table-row position-relative">
                    ...
                    <x-admin.components.table.table-td class="table-name fw-medium">
                        <span class="show-web">{{__('admin/orders.product_quantity')}}</span>{{--{!! $volunteer->last_name !!} {!! $volunteer->first_name !!}--}}
                        john@doe.com
                    </x-admin.components.table.table-td>
                    <x-admin.components.table.table-td class="table-state">
                        <span class="show-web">{{__('admin/orders.ordered_at')}}</span>{{--{!! $volunteer->phone !!}--}} 2943473207
                    </x-admin.components.table.table-td>
                    <x-admin.components.table.table-td class="table-species">
                        <span class="show-web">{{__('admin/orders.state')}}</span>{{--{!! $volunteer->is_admin?   __('admin/volunteers.admin'): __('admin/volunteers.volunteer') !!}--}}Electricien
                        <a href="{{--{{route('pages::volunteers.show',  ['locale' => __('general.currentLocale'),  'volunteer' => $volunteer->id])}}--}}" title="aller vers la page de la commande" class="card-link">
                        </a>
                    </x-admin.components.table.table-td>
                </tr>
                {{--@endforeach--}}
