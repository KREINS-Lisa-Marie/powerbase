                ...
                @for($i=0; $i<10; $i++)
                    ...
                    <tr class="table-row position-relative">
                        ...
                        <x-admin.components.table.table-td class="table-state">
                            <span
                                class="show-web">{{__('admin/orders.ordered_at')}}</span>{{--{!! $volunteer->phone !!}--}}
                            2943473207
                        </x-admin.components.table.table-td>
                        <x-admin.components.table.table-td class="table-species">
                            <span
                                class="show-web">{{__('admin/orders.state')}}</span>{{--{!! $volunteer->is_admin?   __('admin/volunteers.admin'): __('admin/volunteers.volunteer') !!}--}}
                            Electricien
